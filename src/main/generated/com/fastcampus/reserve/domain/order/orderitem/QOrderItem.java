...
public class QOrderItem extends EntityPathBase<OrderItem> {
    ...
    private static final long serialVersionUID = 863012130L;
    ...
    public final com.fastcampus.reserve.domain.order.QOrder order;
    ...
    public final EnumPath<OrderItem.VisitType> visit = createEnum("visit", OrderItem.VisitType.class);
    ...
    public QOrderItem(Class<? extends OrderItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.order = inits.isInitialized("order") ? new com.fastcampus.reserve.domain.order.QOrder(forProperty("order")) : null;
    }
